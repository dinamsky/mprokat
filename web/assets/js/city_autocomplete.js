$( document ).ready(function() {
    ...
    var my_city_autoComplete_search_popup = new autoComplete({
        ...
        onSelect: function(e, term, item){
            $('.pop_s_link').each(function(){
               $(this).attr('href','/rent/'+item.getAttribute('data-url')+'/all/'+$(this).data('gt'));
            });
        }
    });

    $('.close_pop_search').on('click', function () {
        $('#search_popup').addClass('uk-hidden');
    });
